...
export default async function DashboardPage({
  ...
  const trip = await requireScheduledTrip(tripId);
  ...
  const tripSettings = normalizeTripTravelSettings(tripRow);
  const lateCheckinConfirmed = Boolean(tripRow?.late_checkin_confirmed);
  ...
  return (
    <PageContainer>
      ...
      <TripInfoSummary tripId={tripId} settings={tripSettings} />
